...
### TODO: 1) Implement the grow function for the discriminator
### TODO: 2) Implement the mixing factor for the discriminator
### TODO: 3) Implement the Minibatch Standard Deviation Layer in the discriminator
class Discriminator(tf.keras.models.Sequential):
    def __init__(self, resolution = 8, *args, **kwargs):
        ...
        ## The Initial Discriminator Block:
        self.initial_disc_block = tf.keras.models.Sequential(
            [
                standard_conv(filters=num_filters(self.stage + 1),
                              kernel_size=3,
                              strides=1,
                              padding="same"),
                standard_conv(filters=num_filters(self.stage),
        ...
        self.disc_block.append(self.initial_disc_block)
    ...
    def grow(self):
        ...
        grow_disc_block = DiscriminatorBlock(self.stage)
        self.disc_block.append(grow_disc_block)
